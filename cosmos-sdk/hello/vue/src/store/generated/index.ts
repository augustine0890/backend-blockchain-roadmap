...
import AugustineHelloAugustineHelloHello from './augustine/hello/augustine.hello.hello'
...
export default { 
  AugustineHelloAugustineHelloHello: load(AugustineHelloAugustineHelloHello, 'augustine.hello.hello'),
